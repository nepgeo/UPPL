  ...
  return (
    <div className="space-y-5">
      ...
      {match.result === 'completed' && (
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 text-center shadow-sm">
          <span className="text-5xl">🏆</span>
          <h3 className="text-xl font-bold text-green-800 mt-3 mb-1">Match Completed</h3>
          <p className="text-green-600 text-sm">This match has been completed. Scoring is no longer available.</p>
        </div>
      )}
