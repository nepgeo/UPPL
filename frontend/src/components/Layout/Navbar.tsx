      ...
      <div className="px-3 sm:px-4">
        ...
        <div className="flex items-center justify-between h-14 sm:h-16 border-b border-gray-100">
          <div className="flex items-center shrink-0 -ml-1">
            {/* Mobile Menu Button — far left, before logo */}
            <Button
              variant="ghost"
              size="sm"
          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b border-white/20 shrink-0">
                ...
                <button
                  onClick={() => setIsOpen(false)}
                  className="h-8 w-8 flex items-center justify-center rounded-lg hover:bg-white/20 transition-colors"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
                    ...
                    <div className="space-y-0.5">
                      {[
                        ...
                        <Link
                          ...
                          onClick={() => setIsOpen(false)}
                          className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-[13px] font-medium hover:bg-white/20 transition-colors uppercase"
                        >
                          <AdminIcon className="h-3 w-3 flex-shrink-0 opacity-70" />
                          {item.label}
                        </Link>
                        );
                      })}
                ...
                {user && (
                  <div className="mt-4 border-t border-white/20 pt-3">
                    <div className="flex items-center gap-2.5 mb-2.5">
                      <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center overflow-hidden ring-1 ring-white/30 flex-shrink-0">
                        {user.profileImage ? (
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="w-full bg-white/10 text-white border-white/30 font-semibold rounded-lg hover:bg-red-500 hover:text-white hover:border-red-500 transition-all text-[11px] py-1"
                    >
                      Logout
                    </Button>
                  </div>
