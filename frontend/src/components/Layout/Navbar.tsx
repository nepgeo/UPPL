        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-1/2 -translate-x-1/2 z-50 w-[85%] max-w-[320px] 
                ...
                <nav className="space-y-1">
                  {publicLinks.map((link) => {
                    ...
                    <Link
                      ...
                      to={link.path}
                      onClick={() => setIsOpen(false)}
                      className={`flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 uppercase ${
                        isActive(link.path)
